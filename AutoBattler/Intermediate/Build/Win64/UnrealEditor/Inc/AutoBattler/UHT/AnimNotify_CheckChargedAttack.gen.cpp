...
AUTOBATTLER_API UClass* Z_Construct_UClass_UAnimNotify_CheckChargedAttack();
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_School_AutoBattler_FinalThesis_AutoBattler_Source_AutoBattler_Variant_Combat_Animation_AnimNotify_CheckChargedAttack_h__Script_AutoBattler_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAnimNotify_CheckChargedAttack, UAnimNotify_CheckChargedAttack::StaticClass, TEXT("UAnimNotify_CheckChargedAttack"), &Z_Registration_Info_UClass_UAnimNotify_CheckChargedAttack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAnimNotify_CheckChargedAttack), 537313449U) },
	};
}; // Z_CompiledInDeferFile_FID_School_AutoBattler_FinalThesis_AutoBattler_Source_AutoBattler_Variant_Combat_Animation_AnimNotify_CheckChargedAttack_h__Script_AutoBattler_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_School_AutoBattler_FinalThesis_AutoBattler_Source_AutoBattler_Variant_Combat_Animation_AnimNotify_CheckChargedAttack_h__Script_AutoBattler_1536531078{
	TEXT("/Script/AutoBattler"),
	Z_CompiledInDeferFile_FID_School_AutoBattler_FinalThesis_AutoBattler_Source_AutoBattler_Variant_Combat_Animation_AnimNotify_CheckChargedAttack_h__Script_AutoBattler_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_School_AutoBattler_FinalThesis_AutoBattler_Source_AutoBattler_Variant_Combat_Animation_AnimNotify_CheckChargedAttack_h__Script_AutoBattler_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0,
};
// ********** End Registration *********************************************************************
